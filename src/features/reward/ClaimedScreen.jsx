    ...
    <PageShell contentClassName="justify-between p-4 pb-3">
      ...
      <main className="flex-1 flex flex-col items-center justify-center z-20 px-2 -mt-2">
        <div className="bg-brandPinkLight border-2 border-dashed border-brandPink rounded-2xl p-5 w-full max-w-[240px] flex flex-col items-center shadow-2xs">
          <div className="w-44 h-44 rounded-full border-[3px] border-dashed border-festa-rose bg-white flex flex-col justify-center items-center shadow-inner">
            <span className="font-sinchon text-festa-rose text-2xl tracking-widest leading-tight text-center">
              체험완료
            </span>
            <span className="font-sinchon text-festa-navy text-lg mt-1">수뭉이</span>
          </div>
